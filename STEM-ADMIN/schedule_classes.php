...
<?php
 ...
 $sql="select t.tutor_name,s.student_name,sub.subject_name,ts.date_selected,ts.time_selected from tutor t,student s,tutor_student_classes ts,subject sub where ts.tutor_id=t.tutor_id and ts.student_email=s.emailid and ts.subject_id=sub.subject_id and ts.`status`='schedule'";
