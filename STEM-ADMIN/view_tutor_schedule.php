		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right mainNav">
					...
					<li class="active"><a href="view_tutor_schedule.php">View Subjects</a></li>
...
t.c9_4PM,t.c10_5PM,t.`status` from tutor_schedule t where t.tutor_id=16 order by t.tutor_id";
	...
	foreach($scheduleDataSet as $data){
		...
		for($i=0;$i<sizeof($data);$i++){
		 ...
		 if($i>=3 && $i<=sizeof($data)-2){
			 ?>
			<td><span><?=$obj->getSubjectName($data[$i])?></span>
