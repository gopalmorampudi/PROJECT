...
$eventquery="select * from subject where subject_id=$subject_id";
...
<button type="submit" name="action" value="update_subject" class="btn btn-primary">Edit</button>
</div><!-- /.box-body -->
</div><!-- /.box -->
</div><!-- /.col -->
</div><!-- /.row -->
