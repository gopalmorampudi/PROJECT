...
$query.="select st.student_name,s.subject_name,ts.date_selected,ts.time_selected,ts.`status`,ts.id
...
$query.="select st.student_name,s.subject_name,ts.date_selected,ts.time_selected,ts.`status`,ts.id from tutor_student_classes ts,tutor t,student st,subject s  
		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right mainNav">
					...
					<li class="active"><a href="tutor_classes_details.php?usertype=tutor&classtype=current">Classes</a></li>
