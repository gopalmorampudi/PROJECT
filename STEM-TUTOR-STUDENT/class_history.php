...
$query.="select tu.tutor_name,s.subject_name,t.date_selected,t.time_selected,t.`status` from tutor_student_classes t,tutor tu,subject s where t.student_email='$email' and t.tutor_id=tu.tutor_id and t.subject_id=s.subject_id and t.`status`='pending' order by t.date_selected";
$title.='Requeste Classes';
}else if($classtype=='completed'){
$query.="select tu.tutor_name,s.subject_name,t.date_selected,t.time_selected,t.`status` from tutor_student_classes t,tutor tu,subject s where t.student_email='$email' and t.tutor_id=tu.tutor_id and t.subject_id=s.subject_id and t.date_selected<=CURRENT_DATE() and t.`status`='completed' order by t.date_selected";
	$title.='Completed Class';
}else if($classtype=='future'){
$query.="select tu.tutor_name,s.subject_name,t.date_selected,t.time_selected,t.`status` from tutor_student_classes t,tutor tu,subject s where t.student_email='$email' and t.tutor_id=tu.tutor_id and t.subject_id=s.subject_id and t.date_selected>CURRENT_DATE() and t.`status`='schedule' order by t.date_selected";
